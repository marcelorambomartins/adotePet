			...
			<?php
				foreach ($listacaes as $cao) {
					...
					echo "<div class='panel-body'>";
						echo "<a href='http://localhost/viralate/caes/visualizar/" . $cao['id'] . "'><img src='http://localhost/viralate/images/".$cao['imagem']."' alt='Ver mais fotos' height='100%' width='100%'></a>";
